...
namespace uyg04.Controllers
{
    public class ServisController : ApiController
    {
        ...
        [HttpGet]
        [Route("api/derslistesoneklenenler/{s}")]
        public List<DersModel> DersListeSonEklenenler(int s)
        {
            List<DersModel> liste = db.Ders.OrderByDescending(o => o.dersId).Take(s).Select(x => new DersModel()
            {
                dersId = x.dersId,
                dersKodu = x.dersKodu,
                dersAdi = x.dersAdi,
